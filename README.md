...
| [Addy Osmani · Agent Skills](https://github.com/addyosmani/agent-skills/blob/main/README.md) | 上游按需求、计划、构建、验证、评审和交付组织工程技能；本项目收录性能优化、API 与接口设计、可观测性，以及处理旧系统退役、用户迁移和数据库渐进式变更的 `deprecation-and-migration`。 | 已收录 4 项技能及两份检查清单；未引入上游命令、Agent 或 Hook |
